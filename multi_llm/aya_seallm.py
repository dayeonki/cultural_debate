...
model1_id = "CohereForAI/aya-23-8B"
model2_id = "SeaLLMs/SeaLLMs-v3-7B-Chat"

def extract_text_after_header(text):
    if "assistant<|end_header_id|>" in text:
        return text.split("assistant<|end_header_id|>")[-1].split("<|endoftext|>")[0].strip()
    return text
    ...
    with jsonlines.open(args.output_path, mode="w") as outfile:
        with jsonlines.open(args.input_path) as file:
            for line in file.iter():
                ...
                outputs = pipe(messages, max_new_tokens=1024, temperature=0.0)
                generated_text = outputs[0]["generated_text"]
                generated_text = generated_text[1]['content']
                generation1_1 = extract_answer(generated_text)
                ...
                generation2_1 = parse_response(generation, "Answer:")
                ...
                generated_text = outputs[0]["generated_text"]
                generated_text = generated_text[1]['content']
                generation1_2 = extract_answer(generated_text)
                ...
                generation = tokenizer2.batch_decode(generated_ids, skip_special_tokens=True)[0]
                generation2_2 = parse_response(generation, "Response:")
                ...
                generated_text = outputs[0]["generated_text"]
                generated_text = generated_text[1]['content']
                generation1_3 = extract_answer(generated_text)
